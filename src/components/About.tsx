...
const About = () => {
  ...
  return (
    <div className='flex flex-col w-full h-full p-12 lg:p-24 justify-center items-center'>
      <motion.div
        ref={ref}
        initial={{ opacity: 0, y: 50 }}
        animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
        transition={{ duration: 0.5 }}
        className='flex flex-col w-full text-xl leading-[2] md:text-3xl max-w-4xl md:leading-[2]'
      >
